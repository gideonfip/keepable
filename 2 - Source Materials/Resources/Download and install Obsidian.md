...
source: "https://help.obsidian.md/Getting+started/Download+and+install+Obsidian"
published:
created: 2026-04-30
description: "Obsidian is available for all major desktop and mobile platforms. These are all the supported ways to download and install Obsidian."
tags:
  - defuddle
favourites: false
---
...
Find Obsidian on the [Play Store](https://play.google.com/store/apps/details?id=md.obsidian) or download the APK from the [Download Obsidian](https://obsidian.md/download) page.

## Install Obsidian on iPhone and iPad

Find Obsidian on the [App Store](https://apps.apple.com/us/app/obsidian-connected-notes/id1557175442).
