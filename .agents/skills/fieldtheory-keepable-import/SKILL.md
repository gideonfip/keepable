---
name: fieldtheory-keepable-import
...
```bash
python3 .agents/skills/fieldtheory-keepable-import/scripts/import_fieldtheory_to_keepable.py --vault "<vault-path>" --sync --browser <browser> --since-last-sync
```

The cursor is stored in:

```text
<vault-path>/.agents/fieldtheory-keepable-import-state.json
```
...
```bash
python3 .agents/skills/fieldtheory-keepable-import/scripts/import_fieldtheory_to_keepable.py --vault "<vault-path>" --sync --browser <browser> --after 2026-01-01
```
...
```bash
python3 .agents/skills/fieldtheory-keepable-import/scripts/import_fieldtheory_to_keepable.py --vault "<vault-path>" --sync --browser <browser> --after 2026-01-01 --dry-run
```
